    ...
    return [
        Tool(name="search",
            ...
            inputSchema={"type": "object", "properties": {
                ...
                "google_ai_only": {"type": "boolean"},
                "search_type": {"type": "string", "enum": ["auto","text","news","images","videos","books"]},
                "search_prompt": {"type": "string"}, "pro_mode": {"type": "boolean"},
                "gl": {"type": "string"}, "hl": {"type": "string", "default": "en"},
                "tbs": {"type": "string"}, "pws": {"type": "string"},
                 "backend": {"type": "string", "description": "DDG backend: auto/bing/brave/ddg/google/startpage/yahoo/mojeek/wikipedia"},
        ...
        Tool(name="fetch",
            ...
            inputSchema={"type": "object", "properties": {
                ...
                "main_content_only": {"type": "boolean", "default": True},
                ...
                "include_formatting": {"type": "boolean", "default": True},
                 ...
                 "favor_precision": {"type": "boolean"}, "favor_recall": {"type": "boolean"},
                 "fast": {"type": "boolean"}, "prune_xpath": {"type": "string", "description": "XPath prune selectors"},
                 "url_blacklist": {"type": "string", "description": "URL exclude patterns"},
                 "author_blacklist": {"type": "string", "description": "Author exclude patterns"},
                 "block_webrtc": {"type": "boolean"}, "disable_resources": {"type": "boolean", "default": True},
                 "proxy": {"type": "string"}, "locale": {"type": "string"}, "timezone_id": {"type": "string"},
                 "network_idle": {"type": "boolean", "default": True}, "allow_webgl": {"type": "boolean", "default": True},
                 "block_ads": {"type": "boolean", "default": True}, "dns_over_https": {"type": "boolean", "default": True},
                 "solve_cloudflare": {"type": "boolean", "default": True}, "retries": {"type": "integer", "default": 5},
                 "capture_xhr": {"type": "string"}, "wait_selector": {"type": "string"},
                 "wait_selector_state": {"type": "string", "enum": ["attached","detached","visible","hidden"], "default": "attached"},
        ...
        Tool(name="crawl",
            ...
            inputSchema={"type": "object", "properties": {
                ...
                "browser_type": {"type": "string", "enum": ["chromium","firefox","webkit"], "default": "chromium"},
                 ...
                 "js_code": {"type": "string"}, "wait_for": {"type": "string"}, "session_id": {"type": "string"},
                 "check_robots_txt": {"type": "boolean"}, "screenshot": {"type": "boolean"}, "pdf": {"type": "boolean"},
                 "proxy": {"type": "string"}, "magic": {"type": "boolean", "default": True},
                 "flatten_shadow_dom": {"type": "boolean", "default": True}, "process_iframes": {"type": "boolean", "default": True},
                 "scan_full_page": {"type": "boolean", "default": True}, "wait_for_images": {"type": "boolean", "default": True},
                 "word_count_threshold": {"type": "integer", "default": 30}, "page_timeout": {"type": "integer", "default": 60000},
                 "max_retries": {"type": "integer", "default": 2}, "user_agent": {"type": "string"},
                 "headers": {"type": "object"}, "extra_args": {"type": "array", "items": {"type": "string"}},
                 "geolocation_lat": {"type": "number"}, "geolocation_lng": {"type": "number"},
                 "delay_before_return_html": {"type": "number", "default": 0.1}, "stream": {"type": "boolean"},
                 "capture_mhtml": {"type": "boolean"}, "capture_network_requests": {"type": "boolean"},
                 "capture_console_messages": {"type": "boolean"}, "exclude_external_links": {"type": "boolean"},
                 "exclude_social_media_links": {"type": "boolean"}, "target_elements": {"type": "array", "items": {"type": "string"}},
                 "memory_saving_mode": {"type": "boolean"}, "remove_forms": {"type": "boolean"},
                 "keep_data_attributes": {"type": "boolean"}, "score_links": {"type": "boolean"},
        ...
        Tool(name="screenshot",
            ...
            inputSchema={"type": "object", "properties": {
                ...
                "max_chars": {"type": "integer", "default": 10000},
                 ...
                 "clip_x": {"type": "number", "default": 0}, "clip_y": {"type": "number", "default": 0},
                 "clip_width": {"type": "number", "default": 0}, "clip_height": {"type": "number", "default": 0},
                 "image_type": {"type": "string", "enum": ["png","jpeg"], "default": "png"},
        ...
        Tool(name="wikipedia",
            ...
            inputSchema={"type": "object", "properties": {
                ...
                "distance": {"type": "integer", "default": 1000},
        ...
        Tool(name="tavily_research",
            ...
            inputSchema={"type": "object", "properties": {
                ...
                "citation_format": {"type": "string", "enum": ["numbered","mla","apa","chicago"], "default": "numbered"}},
                "required": ["query"]}),
        ...
        Tool(name="exa_similar",
            ...
            inputSchema={"type": "object", "properties": {
                ...
                "subpages": {"type": "integer", "default": 0},
        ...
        Tool(name="pdf_extract",
            ...
            inputSchema={"type": "object", "properties": {
                ...
                "hybrid_url": {"type": "string", "description": "AI backend server URL (default: http://localhost:5002)"},
                "hybrid_timeout": {"type": "string", "description": "AI backend timeout e.g. 120s"},
