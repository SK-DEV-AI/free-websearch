    ...
    return [
        Tool(name="search",
            ...
            inputSchema={"type": "object", "properties": {
                ...
                "tavily_topic": {"type": "string", "enum": ["general","news"], "default": "general", "description": "Tavily search topic — 'news' for current events filtering"},
                "exact_phrase": {"type": "boolean", "description": "Exact phrase matching for Tavily searches"}},
                "required": ["query"]}),
        Tool(name="fetch",
        ...
        Tool(name="screenshot",
            ...
            inputSchema={"type": "object", "properties": {
                ...
                "depth": {"type": "integer", "description": "Max snapshot depth (aria_snapshot)"},
                "boxes": {"type": "boolean", "description": "Include bounding boxes in snapshot"},
